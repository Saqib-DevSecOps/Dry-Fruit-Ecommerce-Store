...
from src.apps.shipment.bll import get_or_refresh_token, create_shiprocket_order, get_all_orders, get_specific_order
from src.apps.shipment.models import ShipmentOrder, ShipmentProduct, ShipmentDetail
from src.administration.admins.filters import ShipmentOrderFilter
...
class ShipmentCreateOrderView(View):
    def post(self, request, pk):
        ...
        if token:
            original_order_data = Order.objects.filter(id=pk)
